...
class SuperuserViewModel(
    ...
    private val itemWhitelistMode = TextItem(R.string.superuser_whitelist_mode)
    ...
    override suspend fun doLoadWork() {
        ...
        // Always show whitelist mode indicator at the top
        itemsHelpers.clear()
        itemsHelpers.add(itemWhitelistMode)
        if (itemsPolicies.isEmpty()) {
